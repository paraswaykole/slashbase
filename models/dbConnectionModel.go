...
func newDBConnection(userID string, teamID string, name string, dbtype string, dbhost, dbport, dbuser, dbpassword, databaseName, useSSH, sshHost, sshUser, sshPassword, sshKeyFile string) (*DBConnection, error) {
...
func NewPostgresDBConnection(userID string, teamID string, name string, dbhost, dbport, dbuser, dbpassword, databaseName, useSSH, sshHost, sshUser, sshPassword, sshKeyFile string) (*DBConnection, error) {
	return newDBConnection(userID, teamID, name, DBTYPE_POSTGRES, dbhost, dbport, dbuser, dbpassword, databaseName, useSSH, sshHost, sshUser, sshPassword, sshKeyFile)
}
