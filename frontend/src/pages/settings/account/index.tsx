...
const AccountPage: NextPage = () => {
  ...
  return (
    <AppLayout title="Your Account | Slashbase">
      <h1>Your Account</h1>
      <br />
      {editableUser &&
        <div className="form-container">
          ...
          <br />
          <hr />
          <Link href={Constants.APP_PATHS.SETTINGS_ACCOUNT_CHANGE_PASSWORD.path} as={Constants.APP_PATHS.SETTINGS_ACCOUNT_CHANGE_PASSWORD.path}>
            <a>
