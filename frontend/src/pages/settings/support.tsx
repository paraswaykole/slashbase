...
const SupportPage: FunctionComponent<{}> = () => {
    ...
    return (
        <React.Fragment>
            ...
            <a href={Constants.EXTERNAL_PATHS.DISCORD_COMMUNITY} target="_blank">
            ...
            <a href={Constants.EXTERNAL_PATHS.REPORT_BUGS} target="_blank">
                <button className="button is-secondary">
            ...
            <a href={Constants.EXTERNAL_PATHS.OFFICIAL_WEBSITE} target="_blank">
                <button className="button is-secondary">
