        ...
        <div className={"card " + styles.cardContainer}>
            <div className={"card-content " + styles.cardContent}>
                ...
                <div className="buttons">
                    <Button className="is-small is-white" icon={<i className="fas fa-table"/>} onClick={updateActiveTabToData}>
                        View Data
                    </Button>
                    <Button className="is-small is-white" icon={<i className="fas fa-list-alt"/>} onClick={updateActiveTabToModel}>
                        View Model
                    </Button>
                </div>
            </div>
