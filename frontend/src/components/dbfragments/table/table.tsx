                ...
                <div className="columns">
                    ...
                    {isInteractive && !isEditing && <React.Fragment>
                        <div className="column is-3 is-flex is-justify-content-flex-end">
                            <Button className="is-primary" icon={<i className="fas fa-pen"/>} onClick={() => { setIsEditing(true) }} />
                        </div>
                    </React.Fragment>}
                    {isInteractive && isEditing && <React.Fragment>
                        <div className="column is-3 is-flex is-justify-content-flex-end">
                            <Button icon={<i className="fas fa-trash"/>} disabled={selectedIDs.length === 0} onClick={() => { setIsDeleting(true) }}/>
                            &nbsp;&nbsp;
                            <Button className="is-secondary" icon={<i className="fas fa-plus"/>} onClick={() => { setIsAdding(true) }}/>
                            &nbsp;&nbsp;
                            <Button className="is-primary" icon={<i className="fas fa-check"/>} onClick={() => { setIsEditing(false) }}/>
                        </div>
                    </React.Fragment>}
                </div>
            </div>}
